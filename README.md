# casaGo Web Project Installation Guide
...
This guide will walk you through the installation process for the casaGo web project. Follow the steps below to set up the project locally on your machine.
...
2. Set up the database:
   ...
   - Add the following line to the `.env` file:
     ...
     ```
     ATLASDB_URL=mongodb://127.0.0.1:27017/casaGo
     ```
...
7. Access the project:
   - Once the server is running, you can access the project at [http://localhost:8080](http://localhost:8080/listings).
